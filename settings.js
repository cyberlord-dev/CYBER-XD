...
// add your Session Id make sure it starts with cyber~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "cyber-xᴅ",
...
// add alive msg here 
        ...
        STICKER_NAME: process.env.STICKER_NAME || "cyber-xᴅ",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "2347061956740",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "cyber lord",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ cyber lord*",
// add bot owner name    
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "2347061956740",
